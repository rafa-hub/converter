//example of batch benchmark tests for new iterative variant BBMC_Iter (*experimental*)
...
//#define SINGLE_INSTANCE_PATH		"C:/Users/pablo/Desktop/normalized-geo50-20-d4-75-19_ext.clq"
//#define SINGLE_INSTANCE_PATH		"C:/Users/pablo/Desktop/normalized-frb45-21-2_ext.clq"
#define SINGLE_INSTANCE_PATH		"C:/Users/pablo/Desktop/r18_0.8_35.txt"
//#define SINGLE_INSTANCE_PATH		"C:\\Users\\pablo\\Desktop\\evil-myc-fbr11-k20_rlf.clq"
...
int main(){
	...
	/*p.alg = clqo::BBMCITXR_L_SEQ;
	batch.add_test<CliqueIter>(p);

	p.alg = clqo::BBMC_Iter_Root_Enlarge;
	batch.add_test<CliqueIter>(p);*/

	/*p.alg = clqo::BBMC_Iter_Root_Enlarge_Sat_R;
	batch.add_test<CliqueIter>(p);*/
...
int main(){
	...
	//random_attr_t rt(200, 200, .95, .95, 10, 50, .1);
	...
	/*p.alg = BBMCITXR_L_SEQ;
	batch.add_test<CliqueIter>(p);

	p.alg = BBMC_Iter_Root_Enlarge;
	batch.add_test<CliqueIter>(p);

	p.alg = BBMC_Iter_Root_Enlarge_Sat_R;
	batch.add_test<CliqueIter>(p);*/
