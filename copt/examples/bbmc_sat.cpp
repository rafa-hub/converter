//example of batch benchmark tests for new iterative variant BBMCX
...
//#define SINGLE_INSTANCE_PATH		"C:/Users/pablo/Desktop/normalized-rand-2-40-25-180-500-13_ext.clq"
//#define SINGLE_INSTANCE_PATH		"C:/Users/pablo/Desktop/evil-tests/evil-N240-p98-myc5x48.clq"
...
#define SINGLE_INSTANCE_PATH_POSIX		"/media/datos/graphs/dimacs_bhosh/brock400_4.clq"
...
int main(){
	...
	//p.init_order=clqo::MIN_WIDTH;						//default conditional ordering
	//p.init_order=clqo::MIN_WIDTH_MIN_TIE_STATIC;		//default conditional ordering
...
int main(){
	...
	//random_attr_t rt(200, 200, .95, .95, 10, 50, .5);
