...
#define PARTITION_SETUP			0x7								//selective algorithms-setup with initial paritioning (currently only for CliqueInfraPlus-29/9/17)	
#ifdef PARTITION_SETUP	
	#undef STRONG_ROOT_COLORING									//no need of color sets
#endif
...
//////////////
//Test Configuration
#define TESTS_DIMACS				0x8										//switch STRUCTURED (DIMACS, CSP, BHOSLIB,...) / RANDOM 
//#define BENCHMARK_PATH			"/var/tmp/salida/color"
//#define BENCHMARK_PATH			"/var/tmp/salida/"
#define BENCHMARK_PATH			   "/var/tmp/salida/dimacs"	
//#define BENCHMARK_PATH				"/var/tmp/salida/dimacs_w"	
//#define BENCHMARK_PATH			"/var/tmp/salida/csp_all"	
//#define BENCHMARK_PATH			"/var/tmp/salida/vcp"	
//#define BENCHMARK_PATH			"/var/tmp/salida/weighted"

//#define BENCHMARK_WEIGHTED_PATH		"/var/tmp/salida/dimacs_w"
#define BENCHMARK_WEIGHTED_PATH		"/var/tmp/salida/dimacs"
//#define BENCHMARK_WEIGHTED_PATH		"/var/tmp/salida/WDP-dimacs/group1"
//#define BENCHMARK_RANDOM_PATH		"/var/tmp/salida/random_w"
#define BENCHMARK_RANDOM_PATH		"/var/tmp/salida/random_1"
//#define BENCHMARK_WEIGHTED_PATH		"/var/tmp/salida/dimacs_w"
//#define BENCHMARK_WEIGHTED_PATH	"/var/tmp/salida/dimacs"
//#define BENCHMARK_WEIGHTED_PATH	"/var/tmp/salida/WDP-dimacs/group1"
//#define BENCHMARK_RANDOM_PATH		"/var/tmp/salida/random_w"
...
//#define BENCHMARK_RANDOM_PATH		"/var/tmp/salida/random"
//#define LOG_DIMACS				"/var/tmp/salida/color.txt"	
#define LOG_DIMACS					"/var/tmp/salida/log_dimacs.txt"
//#define LOG_DIMACS				"/var/tmp/salida/log_dimacs_w.txt"
#define LOG_RANDOM					"/var/tmp/salida/log_random.txt"
//#define LOG_RANDOM				"/var/tmp/salida/log_random_w.txt"
//#define BENCHMARK_RANDOM_PATH		"/var/tmp/salida/random"	
//#define LOG_DIMACS				"/var/tmp/salida/color.txt"	
...
#define TEST_ELIMINATE_FAILED_NODES					0x9					//switch to find one more conflict by proving all nodes are FAILED in a CLAUSE
#define TEST_LOOK_AHEAD_ISETS						0x10
//#define FIVE_ISET_FILTER							0x11				/*alternates between 4 and 5 ndoes in color sets where nodes may be removed */
#ifdef TEST_LOOK_AHEAD_ISETS	
	#define FURTHER_TEST_FAILED_COLOR_SETS			0x12				//switch to involve reduced stack when FAILING CLAUSES
#endif
#ifdef TEST_ELIMINATE_FAILED_NODES
	#define FURTHER_TEST_ELIMINATE_FAILED_NODES		0x13				//switch for involving reduced stack when trying to FAIL all nodes in a CLAUSE
#endif 
...
//russian doll params
#define RDOLL_INC_UB_CUT							0x14
//#define RDOLL_MIN_UB_ON_RETURN					0x15
...
public:
	...
	enum init_order_t	{RLF_COND=0, MIN_WIDTH_MIN_TIE_STATIC, MIN_WIDTH, MIN_WIDTH_BIG, MAX_WIDTH, MAX_WIDTH_MAX_TIE, MAX_WIDTH_MAX_TIE_STATIC,  MAX_ABS, MIN_WIDTH_KCORE, RLF, NONE, MIN_WIDTH_COMPOSITE, MIXED_2, MIXED_3, MIXED_4, 
...
public:
	...
	void decode_first_solution	(vint& lv)	{ d.decode_list(res.get_first_solution(),lv);}
