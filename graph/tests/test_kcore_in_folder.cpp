...
#define LOG_FILE  "C:\\Users\\Pablo\\Desktop\\kcore_number.txt"
...
TEST(Folder_tests, kcore){
   ...
   do
   {
      ...
      else
      {
		 ...
		 fs<<ffd.cFileName<<":"<<kc.get_kcore_number()<<":"<<secs<<endl;
